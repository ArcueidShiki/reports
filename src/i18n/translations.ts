...
const en: TranslationDictionary = {
  ...
  'footer.tagline': 'Compiled nightly. Read at dawn.',
  'home.kicker': 'The Nightly Ledger',
  'home.tagline': 'Daily reports on products, markets, and quant signals.',
  'home.sections': 'Index',
  'page.kicker.products': 'Product Discovery',
  'page.kicker.market': 'Daily Briefing',
  'page.kicker.alpha': 'Factor Library',
  'page.kicker.signals': 'Macro Calendar',
  'page.kicker.wisdom': 'Commonplace Book',
  'page.kicker.gallery': 'Daily Renders',
  ...
  'home.desc.wisdom': 'Timeless investing quotes from the great investors.',
  ...
  'products.trendReport': 'Trend Report',
  'products.reportCard': 'Report Card',
  'products.analysisCards': 'Analysis Cards',
...
const zh: TranslationDictionary = {
  ...
  'footer.email': '邮箱',
  'footer.resume': '简历',
  'footer.tagline': '夜间编纂，晨间阅读。',
  'home.kicker': '每夜一册',
  'home.tagline': '每日产品、市场与量化信号报告。',
  'home.sections': '目录',
  'page.kicker.products': '产品发现',
  'page.kicker.market': '每日简报',
  'page.kicker.alpha': '因子库',
  'page.kicker.signals': '宏观日历',
  'page.kicker.wisdom': '大师语录',
  'page.kicker.gallery': 'AI 视觉集',
  'home.desc.products': '每日产品发现与商业模式分析。',
  'home.desc.market': '中英双语美股每日复盘。',
  'home.desc.alpha': '技术面、基本面与情绪因子库。',
  'home.desc.signals': '宏观事件日历、信号报告与海报。',
  'home.desc.wisdom': '投资大师的经典语录与智慧。',
  ...
  'products.trendReport': '趋势报告',
  'products.reportCard': '报告卡片',
  'products.analysisCards': '分析卡片',
